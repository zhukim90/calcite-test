...
/**
 * ʹ��proxy�ķ�ʽ����impala�������������ʹ�ô���ķ�ʽ������ֱ��ʹ��hive jdbc���ӡ�
 * �����ڴ���ķ�ʽ��Ϊhiveʹ�õĴ������Ϊhive.server2.proxy.user=xxx������impalaʹ�õĲ���Ϊimpala.doas.user
 * ���ǲ��ܹ�ֱ��ͨ����url������ϲ�����ָ������Ϊhive-jdbc��openSession��ʱ�������еĲ�������
 * set:hiveconf:��set:hivevar:��ǰ׺������impala����ʶ�������ʹ��proxy��ʱ����ֱ��ʹ��hive-jdbc��
 * 
 * Input: hive jdbc url,����hive url�ĸ�ʽ,��Ҫʹ��һ���ɴ����û�ִ��
 * Output : TCLIService.Iface�����Ѿ�ִ��openSession��
 * 
 */
